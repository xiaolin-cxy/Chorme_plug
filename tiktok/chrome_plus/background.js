...
//                             error:function(data){}
//                         },{
//                             url:"https://buyin.jinritemai.com/api/authorStatData/matchAnalyze?uid"+adata.data["list"][0]["author_base"]["uid"],
//                             type:"GET",
//                             dataType:"json",
//                             data:null,
//                             success:function(bdata){
//                                 console.log("======>")
//                                 console.log(bdata.data["list"][0]["author_base"]["uid"])
//                                 chrome.tabs.sendMessage(details.tabId,{
//                                     "data1":bdata["data"]["author_data"][i]["title"]+":"+a["data"]["author_data"][i]["current_author"]
//                                 },(res)=>{
//                                     console.log("send")
//                                     console.log(data1)
//                                 })
